...
public class ConsultaProductoController {
    final String VIEW = "consultas"; // identificador de la vista
    final String VIEW_PATH = "consultas";
    String operacion = "";
    final String FORM_VIEW = VIEW_PATH + "/consultaProductos";
    final String FORM_NEW = VIEW_PATH + "/nuevo";
    final String FORM_EDIT = VIEW_PATH + "/consultaProductoDetalle";
    final String RD_FORM_VIEW = "redirect:/consultaProductos";
