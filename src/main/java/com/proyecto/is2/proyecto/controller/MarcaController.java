...
public class MarcaController {
    final String VIEW = "marca"; // identificador de la vista
    final String VIEW_PATH = "marca";
    String operacion = "";
    final String FORM_VIEW = VIEW_PATH + "/marcas";
    final String FORM_NEW = VIEW_PATH + "/nuevo";
    final String FORM_EDIT = VIEW_PATH + "/editar";
    final String RD_FORM_VIEW = "redirect:/marcas";
